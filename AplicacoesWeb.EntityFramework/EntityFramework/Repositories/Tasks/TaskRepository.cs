...
namespace AplicacoesWeb.EntityFramework.Repositories.Tasks
{
    /// <summary>
    /// Implements <see cref="ITaskRepository"/> for EntityFramework ORM.
    /// </summary>
    public class TaskRepository : AplicacoesWebRepositoryBase<Task, long>, ITaskRepository
    {
        public TaskRepository(IDbContextProvider<AplicacoesWebDbContext> dbContextProvider)
